package vault.transitions.slide
{
	...
	public class Transition_SlideTop extends TransitionType
	{
		...
		public function Transition_SlideTop( from:Bitmap, to:Bitmap )
		{
			super( from, to );
		}
		...
		override public function start():void
		{
			...
			tl.append( new TweenLite( _fromSprite, 1, { y : -( ( _fromSprite.height >> 1 ) * scaleDownTo ) } ) );
		}
