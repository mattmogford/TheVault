package vault.transitions.slide
{
	...
	public class Transition_SlideRight extends TransitionType
	{
		...
		public function Transition_SlideRight( from:Bitmap, to:Bitmap )
		{
			super( from, to );
		}
		...
		override public function start():void
		{
			...
			tl.append( new TweenLite( _fromSprite, 1, { x : _fromSprite.width + ( ( _fromSprite.width >> 1 ) * scaleDownTo ) } ) );
		}
