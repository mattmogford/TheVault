package vault.transitions.slide
{
	...
	public class Transition_SlideBottom extends TransitionType
	{
		...
		public function Transition_SlideBottom( from:Bitmap, to:Bitmap )
		{
			super( from, to );
		}
		...
		override public function start():void
		{
			...
			tl.append( new TweenLite( _fromSprite, 1, { y : _fromSprite.height + ( ( _fromSprite.height >> 1 ) * scaleDownTo ) } ) );
		}
		
		private function startToAnim():void
		{
			var tl:TimelineLite = new TimelineLite( { onComplete : resetBitmaps } );
			tl.append( new TweenLite( _toSprite, 1, { y : _centreY } ) );
