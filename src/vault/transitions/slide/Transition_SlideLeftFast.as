package vault.transitions.slide
{
	...
	public class Transition_SlideLeftFast extends TransitionType
	{
		...
		public function Transition_SlideLeftFast( from:Bitmap, to:Bitmap )
		{
			super( from, to );
		}
		...
		override public function start():void
		{
			...
			tl.append( new TweenLite( _fromSprite, 0.5, { x : -( ( _fromSprite.width >> 1 ) * scaleDownTo ) } ) );
		}
