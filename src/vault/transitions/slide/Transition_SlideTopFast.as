package vault.transitions.slide
{
	...
	public class Transition_SlideTopFast extends TransitionType
	{
		...
		public function Transition_SlideTopFast( from:Bitmap, to:Bitmap )
		{
			super( from, to );
		}
		...
		override public function start():void
		{
			...
			_toSprite.y = _fromSprite.height + ( _toSprite.height >> 1 );
			
			var tl:TimelineLite = new TimelineLite();
			tl.append( new TweenLite( _fromSprite, 0.25, { scaleX : scaleDownTo, scaleY : scaleDownTo, onComplete : startToAnim } ) );
			tl.append( new TweenLite( _fromSprite, 0.5, { y : -( ( _fromSprite.height >> 1 ) * scaleDownTo ) } ) );
		}
